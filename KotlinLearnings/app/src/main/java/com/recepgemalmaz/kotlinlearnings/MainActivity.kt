package com.recepgemalmaz.kotlinlearnings
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mixedArray = arrayOf("Recep",5)
        ...
        myStringArrayList.add("Gemalmaz")
